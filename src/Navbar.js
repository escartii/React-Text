  ...
  return (
    <nav className="navbar">
      <div className="navbar-items">
        <p className="navbar-subtitle">Bienvenido !</p>
      </div>
      <div className="navbar-buttons">
        <a
          href="https://buymeacoffee.com/escartidawq"
          target="_blank"
        ...
        {/* Botón de "Star on GitHub" utilizando Tailwind CSS como un enlace */}
        <a
          href="https://github.com/escartii/React-Text"
          target="_blank"
          rel="noopener noreferrer"
